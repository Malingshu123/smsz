  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="应用类型" prop="type">
        <el-select v-model="queryParams.type" placeholder="请选择应用类型" clearable>
          <el-option
    ...
    <el-table v-loading="loading" :data="resourceList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="对应的超链接地址" align="center" prop="url" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="对应的超链接地址" prop="url">
...
export default {
  ...
  data() {
    return {
      ...
      rules: {
        ...
        url: [
          { required: true, message: "对应的超链接地址不能为空", trigger: "blur" }
        ],
      }
    };
  },
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除应用编号为"' + ids + '"的数据项？').then(function() {
